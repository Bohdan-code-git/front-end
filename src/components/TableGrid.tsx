...
interface TableGridProps {
    tables?: Table[] | null; // может быть null
...
export const TableGrid = ({ tables, selectedTable, onSelectTable }: TableGridProps) => {
    ...
    const safeTables: Table[] = Array.isArray(tables) ? tables : [];

    const groupedTables = {
        main: safeTables.filter((t) => t.location === "main"),
        terrace: safeTables.filter((t) => t.location === "terrace"),
        private: safeTables.filter((t) => t.location === "private"),
    };
