...
import { mockMonthlyStats } from "@/data/mockUsers";
...
const AdminReports = () => {
  ...
  const [selectedMonth, setSelectedMonth] = useState(mockMonthlyStats[0].month);
  ...
  const currentStats = mockMonthlyStats.find((s) => s.month === selectedMonth) || mockMonthlyStats[0];
  const completionRate = Math.round((currentStats.completedReservations / currentStats.totalReservations) * 100);
